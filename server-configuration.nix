...

{
  ...
  security.acme = {
    ...
    certs."{{web-domain}}" = {
      ...
      # This following file contains two lines:
      ...
      postRun = ''
        install --directory --owner=nginx --group=nginx --mode=766 /etc/nginx
        install --directory --owner=nginx --group=nginx --mode=700 /etc/nginx/certs
        install --directory --owner=nginx --group=nginx --mode=700 /etc/nginx/certs/{{web-domain}}
